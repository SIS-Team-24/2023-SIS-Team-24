  ...
  return (
    <div>
      ...
      <div className="ml-80 mt-10">
        <p className="mt-8"> If you want to learn more about BERT, here are some links: </p>
            <p className="mt-8 ml-30 text-blue-600"> https://huggingface.co/blog/bert-101#2-how-does-bert-work </p>
            <p className="mt-5 ml-30 text-blue-600">https://d2l.ai/chapter_natural-language-processing-pretraining/bert-dataset.html </p>
      </div>
